...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="lrml:LegalRuleML">
        <RuleML>
            ...
            <xsl:attribute name="rdf_export_classes">placed_on_market_rezani_duvan_individual placed_on_market_rezani_duvan_legal_entity placed_on_market_rezani_duvan_legal_entity_responsible_individual to_pay_min_cl6_ind to_pay_max_cl6_ind to_confiscate_cl6_ind to_pay_min_cl6_le to_pay_max_cl6_le to_confiscate_cl6_le to_prohibit_min_cl6_le to_prohibit_max_cl6_le to_pay_min_cl6_le_ri to_pay_max_cl6_le_ri to_confiscate_cl6_le_ri to_prohibit_min_cl6_le_ri to_prohibit_max_cl6_le_ri unauthorized_wholesale_distribution_lv1 unauthorized_wholesale_distribution_lv2n unauthorized_wholesale_distribution_lv2p unauthorized_wholesale_distribution_lv3 to_imprison_min_cl12_lv1 to_imprison_max_cl12_lv1 to_confiscate_cl12_lv1 to_imprison_min_cl12_lv2n to_imprison_max_cl12_lv2n to_confiscate_cl12_lv2n to_imprison_min_cl12_lv2p to_imprison_max_cl12_lv2p to_confiscate_cl12_lv2p to_imprison_min_cl12_lv3 to_imprison_max_cl12_lv3 to_confiscate_cl12_lv3</xsl:attribute>
